...
async function create20EZTestUsers() {
  console.log('🌱 开始创建20个EZtest用户...\n');
  ...
  try {
    ...
    for (let i = 1; i <= 20; i++) {
      try {
        ...
        successCount++;
        console.log(`  ✓ [${successCount}/20] 创建用户: ${userName} (${email})`);
      } catch (error) {
        errorCount++;
