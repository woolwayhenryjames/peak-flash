...
async function create10MoreEZTestUsers() {
  console.log('🌱 开始创建更多10个EZtest用户...\n');
  ...
  try {
    ...
    console.error('❌ 创建时出错:', error.message);
  } finally {
    await connection.end();
  }
}

create10MoreEZTestUsers();
