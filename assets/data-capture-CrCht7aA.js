import{b6 as $,b0 as y,b1 as l,a_ as S,a$ as x,bg as m,aL as p,aB as g,aM as h,bc as u,b5 as _,bh as E,bi as C}from"./components-BaBUqtF7.js";import{W as R}from"./index-BdPH8b3o.js";import{ReownAuthentication as v}from"./features-Lzo19uym.js";import"./chunk-OIYGIGL5-sLubLBLN.js";const D=$`
  .email-sufixes {
    display: flex;
    flex-direction: row;
...
`;var d=function(r,t,i,a){var n=arguments.length,e=n<3?t:a===null?a=Object.getOwnPropertyDescriptor(t,i):a,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")e=Reflect.decorate(r,t,i,a);else for(var s=r.length-1;s>=0;s--)(o=r[s])&&(e=(n<3?o(e):n>3?o(t,i,e):o(t,i))||e);return n>3&&e&&Object.defineProperty(t,i,e),e};let c=class extends y{constructor(){super(...arguments),this.email=p.state.data?.email??g.getAccountData()?.user?.email??"",this.address=g.getAccountData()?.address??"",this.loading=!1,this.appName=m.state.metadata?.name??"AppKit",this.siwx=m.state.siwx,this.isRequired=Array.isArray(m.state.remoteFeatures?.emailCapture)&&m.state.remoteFeatures?.emailCapture.includes("required"),this.recentEmails=this.getRecentEmails()}connectedCallback(){(!this.siwx||!(this.siwx instanceof v))&&h.showError("ReownAuthentication is not initialized. Please contact support."),super.connectedCallback()}firstUpdated(){this.loading=!1,this.recentEmails=this.getRecentEmails(),this.email&&this.onSubmit()}render(){return l`
