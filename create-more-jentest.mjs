...
async function createMoreJENTestUsers() {
  console.log('🌱 开始创建更多JENtest测试用户...\n');
  ...
  try {
    ...
    for (let i = 11; i <= 15; i++) {
      try {
        ...
        successCount++;
        console.log(`  ✓ [${successCount}/5] 创建用户: ${userName} (${email})`);
      } catch (error) {
        errorCount++;
