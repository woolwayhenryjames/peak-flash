...
async function create40JENTestUsers() {
  console.log('🌱 开始批量创建40个JENtest用户...\n');
  ...
  try {
    ...
    for (let i = 46; i <= 85; i++) {
      try {
        ...
        successCount++;
        console.log(`  ✓ [${successCount}/40] 创建用户: ${userName}`);
      } catch (error) {
        errorCount++;
