...
export default function Dashboard() {
  return (
    <div>
      ...
      {/* Main Content */}
      <div
        className="flex-1 space-y-18 px-18 pb-14"
        style={{
          background:
      ...
      >
        <RawData />
        <div className="h-px w-full bg-gradient-to-r from-transparent via-[#6c6c6c]/50 to-transparent" />
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-[7px]">
                  ...
                  >
                    ...
                    <g clip-path="url(#clip0_666_3384)">
                      <path
                ...
                <span className="text-[#ACACAC] text-sm underline">
                  View All
                </span>
              </div>
