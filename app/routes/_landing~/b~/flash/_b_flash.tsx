...
import type { Route } from "./+types/_b_flash";
...
const mockFlashes = Promise.resolve([]);

export function loader() {
  // No authentication required for prototype demonstration
  return { flashesPromise: mockFlashes };
}

export default function Flash({ loaderData }: Route.ComponentProps) {
