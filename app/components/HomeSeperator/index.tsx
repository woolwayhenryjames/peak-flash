    ...
    <div className="relative w-full">
      ...
      >
        ...
        <g>
          ...
          <path
            d="M69.295 113H-4v71h398v-63.909c0 20.509-66.202 25.636-99.303 25.636H153.624c-2.276-.453-2.786-1.073-3.153-2.182v-5.454c-.762-1.297-1.442-1.785-3.152-2.182h-30.737c-2.464.067-3.205.595-3.94 2.182v6c-.503 1.358-1.239 1.656-3.153 1.636H75.6c-2.3-.474-3.084-1.018-3.152-2.727v-27.273c-.123-1.571-.68-2.225-3.153-2.727z"
            fill="#0C0C14"
