...
export default function VideoCard({
  ...
  return (
    <div
      className={cn(
        "flex gap-[6px] rounded-md border border-white/20 px-4 py-3",
        containerClassName
      )}
    >
      ...
      >
        ...
        <div className="flex h-full flex-1 flex-col justify-between">
          {/* Title */}
          <h3 className="line-clamp-3 font-medium text-sm text-white leading-[1.5em]">
            {video.description || "Untitled Video"}
          </h3>
          <div className="font-light text-[#ababab] text-[10px]">
            {creator} • KINDLE Score: {kindleScore.toFixed(1)}
          </div>
          ...
          <div className="flex items-center justify-evenly gap-0.5">
            ...
            <div className="flex items-center gap-[5px]">
              ...
              >
                ...
                <circle cx="10" cy="10" fill="black" fillOpacity="0.7" r="10" />
                <path
